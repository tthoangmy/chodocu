...
<div class="card">
   <form method="post" action="" enctype="multipart/form-data">
      <h2 class="title"> Thay đổi thông tin tài khoản</h2>
      <br>

      <div class="email-login">
         <label for="email"> <b>Tài khoản</b></label>
         <input type="text" value="<?php echo $fetch_user['email'];?>" placeholder="Email hoặc số điện thoại" name="email" required>
      ...
      <button class="cta-btn" name="edit_account" type="submit">Lưu thông tin</button>
   </form>
</div>
    ...
    if(isset($_POST['edit_account'])){
            ...
            if($email_count > 0){
                ...
                if($update_email){
                    ...
                    echo "<script>window.open(window.loaction.helf,'_self')</script>";
