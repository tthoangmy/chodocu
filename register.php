...
<div class="card">
   <form method="post" action="" enctype="multipart/form-data">
      ...
      <p class="subtitle">Bạn đã có tài khoản? <a href="index.php?action=login"> Đăng nhập</a></p>
      ...
      <div class="social-login">
         <button class="google-btn">
            ...
            <p class="btn-text">Sử dụng tài khoản Google</p>
         </button>
         <button class="fb-btn">
      ...
      <div class="email-login">
         ...
         <input type="text" placeholder="Phương thức liên lạc" name="contact" required>
         <label for="address"> <b>Địa chỉ</b></label>
         <input type="text" placeholder="Địa chỉ liên hệ" name="address" required>
